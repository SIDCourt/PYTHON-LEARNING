#DAY 01 - Aquaponics automation
# water levels
# water temperature in Fahrenheit
water_temp_minimum_f= 74 
water_temp_maximum_f = 78 

current_water_temp_f = float(input("What is the current water temperature in Fahrenheit? "))
if current_water_temp_f > water_temp_maximum_f:
    print(f"The water is too hot for the fish at {current_water_temp_f}F.")
elif current_water_temp_f < water_temp_minimum_f:
    print(f"The water is too cold for the fish at {current_water_temp_f}F.")
else:
    print(f"The water temperature is just right for the fish at {current_water_temp_f}F.")
